          ...
          <main className={styles.content}>
            ...
            <header className={styles.headerSection}>
              ...
              <p className={styles.subtitle}>
                See who has registered for each event you organize. Registrations update when attendees
                use Register on the event page.
              </p>
            </header>
              ...
              <>
                ...
                <div className={styles.card}>
                  ...
                  {!regLoading && registrations.length === 0 && !regError ? (
                    <p className={styles.muted}>
                      No one has registered yet. When attendees register for this published event, they
                      appear here.
                    </p>
                  ) : null}
                        ...
                        <tbody>
                          {registrations.map((row) => (
                            <tr key={String(row.user_id)}>
                              ...
                              <td className={styles.mono}>{formatRegisteredAt(row.created_at)}</td>
